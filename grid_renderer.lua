...
function renderer:new(grid_obj, draw_mask)
...
function renderer:setup_draw(draw_mask, thickness, wall_color, highlight_color, back_color)
	if draw_mask and type(draw_mask) then 

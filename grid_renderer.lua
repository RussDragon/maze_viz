...
function renderer:new(grid_obj, ox, oy, window_w, window_h)
	...
	obj.draw_conf.window_h = window_h
	obj.draw_conf.window_w = window_w

	obj.draw_conf.v_length = window_h / grid_obj.rows
	obj.draw_conf.h_length = window_h / grid_obj.columns
